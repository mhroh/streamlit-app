...
- **실시간 피드백**: "내 의견 평가받기" 버튼으로 즉시 피드백 받기
...
📁 구글 드라이브 폴더 (선택)
  ...
  │   학생이름 | 대화내역 | 메시지수 | 저장시간 | 상태 | 평가점수 | 평가내용
...
2. 이름 입력
3. 토론 시작!
4. 중간에 피드백 필요하면 **"💬 내 의견 평가받기"** 클릭
5. 토론 끝나면 **"🏁 토론 종료 및 평가받기"** 클릭
...
**Q: 여러 학생이 같은 이름을 쓰면?**
A: 같은 날짜, 같은 주제에서는 마지막 학생의 기록으로 덮어쓰여집니다. 학생들에게 "이름_학번" 형식으로 입력하도록 안내하세요.
